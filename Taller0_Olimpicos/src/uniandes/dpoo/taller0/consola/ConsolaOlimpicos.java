...
public class ConsolaOlimpicos
{
	...
	//Ejecutar pais atleta
	private void ejecutarPaisdeAtleta()
	{
		String nombre_atleta = input("Ingrese el nombre del atleta que le interesa");
		Atleta info_atleta = calculadora.buscarAtleta(nombre_atleta);
		if (info_atleta == null)
		{
			System.out.println("No se encontró un atleta llamado " + nombre_atleta);
		}
		...
		{	
			Pais pais = info_atleta.darPais();
			System.out.println("El pais del atleta " + nombre_atleta + " es " + pais.darNombre());
		}
	}
